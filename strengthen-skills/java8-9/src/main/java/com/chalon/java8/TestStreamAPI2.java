...
import com.chalon.java8.Employee1;
...
public class TestStreamAPI2 {
	...
	public void test2(){
		...
		Optional<Employee1> op2 = emps.parallelStream()
	...
	public void test3(){
		...
		Optional<Employee1> op2 = emps.stream()
	...
	@Test
	public void test4(){
		Stream<Employee1> stream = emps.stream()
		 .filter((e) -> e.getStatus().equals(Employee1.Status.FREE));
		
		long count = stream.count();
		
		stream.map(Employee1::getSalary)
			.max(Double::compare);
	}
}
