...
public class TestStreamAPI3 {
	...
	List<Employee1> emps = Arrays.asList(
			new Employee1(102, "李四", 79, 6666.66, Employee1.Status.BUSY),
	...
	public void test4(){
		...
		Optional<Employee1> op = emps.stream()
	...
	@Test
	public void test5(){
		Map<Employee1.Status, List<Employee1>> map = emps.stream()
	...
	@Test
	public void test6(){
		Map<Employee1.Status, Map<String, List<Employee1>>> map = emps.stream()
	...
	@Test
	public void test7(){
		Map<Boolean, List<Employee1>> map = emps.stream()
